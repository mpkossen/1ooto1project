...
public class Main {
	...
	datum.set(1999, 11, 1);
	Vliegtuig vt4 = new Vliegtuig(lvm, vtt4, "Sukke", datum);
	datum.set(2005, 8, 1);
	Vliegtuig vt5 = new Vliegtuig(lvm, vtt5, "Cargo 1", datum);
	...
	Luchthaven lh4 = new Luchthaven("Heathrow", "HTW", true, l5);
	Luchthaven lh5 = new Luchthaven("Brussel", "BRU", false, l2);
